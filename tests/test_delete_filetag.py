...
def test_delete_filetag_should_delete_filetags_from_db(tmpfile, sample_filetag):
...
def test_delete_filetag_shouldnt_delete_tags_from_db(tmpfile, sample_filetag):
    tag.delete_filetag(tmpfile, "testtag")
    assert tag.count_tags() == 1


def test_delete_filetags_should_ignore_filetags_not_in_db(tmpfile, sample_filetag):

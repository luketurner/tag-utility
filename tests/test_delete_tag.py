...
def test_delete_tag_should_delete_tags_from_db(conn, tmpfile, sample_file_tag):
...
def test_delete_tag_should_ignore_tags_not_in_db(conn, tmpfile, sample_file_tag):
